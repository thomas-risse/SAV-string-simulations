...
def draw_loglog_slope(fig, ax, origin, width_inches, slope, inverted=False, color=None, polygon_kwargs=None, label=True, labelcolor=None, label_kwargs=None, zorder=None):
    ...
    right_center_disp = a_disp + 0.5 * (c_disp - a_disp)
    ...
    offset_ylabel = [-0.33 * label_kwargs["fontsize"], 0.0] #[0.33 * label_kwargs["fontsize"], 0.0] if not inverted else [-0.33 * label_kwargs["fontsize"], 0.0]
    ...
    ax.annotate(f"${slope}$", right_center, xytext=offset_ylabel, textcoords='offset points', ha="right", va="center", zorder=zorder, **label_kwargs)
